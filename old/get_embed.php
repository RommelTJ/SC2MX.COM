<?php
$allowed_channels = array('horusstv', 'rommeltj', 'beefchief3', 'zafhir', 'jimrsng',      
	                  'lowcloud1', 'zapo_colorado', 'xgsrevenge', 'itmax', 'sc2la', 
                          'rohteamtv', 'lms2tv', 'renosoft', 'fwdnarutokun', 'grbindomitus',
                          'samsc2','fritangatv', 'jeikostate');
